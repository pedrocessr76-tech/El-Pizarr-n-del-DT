...
var team_player_entity_1 = require("./team-player.entity");
var TeamModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([team_entity_1.TeamEntity, team_player_entity_1.TeamPlayerEntity])],
