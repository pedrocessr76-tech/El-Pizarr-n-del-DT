...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(userRepo, jwtService) {
            this.userRepo = userRepo;
            this.jwtService = jwtService;
        }
        AuthService_1.prototype.register = function (username, password) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, hashedPassword, user, payload;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { id: user.id, username: user.username, createdAt: user.createdAt }];
                    }
                });
            });
        };
