...
var AppController = function () {
    var _classDecorators = [(0, common_1.Controller)(), (0, swagger_1.ApiTags)('General')];
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getPositions = function () {
            return __awaiter(this, void 0, void 0, function () {
                var positions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.appService.getPlayerPositions()];
                        case 1:
                            positions = _a.sent();
                            return [2 /*return*/, {
    ...
    (function () {
        ...
        _getHello_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Ruta raíz del backend' })];
        _getPositions_decorators = [(0, common_1.Get)('debug/positions'), (0, swagger_1.ApiOperation)({ summary: 'Verificar posiciones en la base de datos' })];
