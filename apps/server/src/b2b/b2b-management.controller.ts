...
export class B2bManagementController {
  ...
  @Get('metrics/summary') @B2bRoles(B2bRoleCode.OWNER, B2bRoleCode.ADMIN, B2bRoleCode.OPERATOR) metricsSummary(@CurrentB2bUser() user: B2bJwtUser, @Query('date') date?: string, @Query('courtId') courtId?: string) { return this.service.metricsSummary(user, date, courtId); }
