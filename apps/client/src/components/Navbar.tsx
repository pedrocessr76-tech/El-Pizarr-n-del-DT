      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-[#15803d]/20 border border-[#15803d]/40 rounded-lg text-sm font-montserrat font-semibold text-[#86efac] hover:bg-[#15803d]/30 transition-colors"
